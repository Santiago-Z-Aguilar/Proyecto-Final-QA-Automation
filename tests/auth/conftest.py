...
def _signup_case(case: Dict[str, Any], auth_headers, prefix: str) -> Tuple[Any, str, Optional[Dict[str, Any]]]:
    ...
    try:
        ...
        # Obtener usuario solo si fue 201 (incluye duplicados manejados)
        ...
        # Cleanup híbrido:
        try:
            # Borrar si el usuario fue creado (201) o si existe
            should_cleanup = (
                    (resp and resp.status_code == 201) or
                    get_user_by_email(email, auth_headers) is not None
            )
